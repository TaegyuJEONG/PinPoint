    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-16 flex items-center border-b backdrop-blur-md sticky top-0 z-50 bg-white/80">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6">
          ...
          <Link href="/login" className={buttonVariants({ size: 'sm', className: 'bg-indigo-600 hover:bg-indigo-700' })}>
            Get Started
          </Link>
        </nav>
      </header>
          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                <h1 className="text-4xl font-extrabold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl/none bg-clip-text text-transparent bg-linear-to-r from-indigo-600 to-purple-600">
              ...
              <div className="space-x-4">
                <Link href="/login" className={buttonVariants({ size: 'lg', className: 'bg-indigo-600 hover:bg-indigo-700 px-8 py-6 text-lg' })}>
